...
#INSTRUCTION - 750X50
#NEXT - PRETTY SMALL
#DS SELECT - EXTREME RIGHT 250X500

#print("Enter Number of Data Structures: ")
#n = int(input())
...
final = {'stack': [['s1', 'int', '5', ['push(5)']], ['s2', 'int', '6', ['pop()']], ['s3', 'int', '4', ['pop()', 'push(4)']]], 'list': [['l1', 'char', '6', ['insert(1,4)', 'pop()']], ['l2', 'char', '5']], 'array': [['a1', 'int', '9', ["append(1)", "append(2)", "sort()"]]]}
"""
"""
objects = ['a1', 'l1', 'l2', "q1"]
final = {'stack': [], 'array': [['a1', 'int', '4', ['append(1)']]], 'linkedlist': [['l1', 'char', '6'], ['l2', 'char', '5']], "queue":[["q1", "int", "6"]]}
"""
...
class Array:
    ...
    def sort(self):
        ...
        self.update()
        var = {"i":0, "j":0}
        for i in range(self.append_index-1):
            for k in range(i+1):
...
class Linked_List:
    ...
    def insert(self, pos = -1, x = "NULL"):
        ...
        self.var["head"] = self.list[0][1]
        self.update()
        write("Inserted "+str(x)+" At Position "+str(pos))
        time.sleep(3)
...
def extract(meth):
    ...
    vals = (meth[meth.index("(")+1:-1]).split(",")
